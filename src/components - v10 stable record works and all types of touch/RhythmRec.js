...
const RhythmRec = ({ start }) => {
      ...
      array.forEach((item, i) => {
        notesToPersNew = [
          ...notesToPersNew,
          {
            ...
            time: item.time,
            id: i + counter + 1,
            endId: Number(item.endId) === 0 ? 0 : idList[+item.endId],
            type: item.type,
            newType: item.type,
          },
        ];
  ...
  const touchStartHandler = (e) => {
    ...
    setNewBeats((prevState) => [
      ...prevState,
      [e.changedTouches[0].pageX, e.changedTouches[0].pageY, dur, "startSlide"],
    ]);
  };
  ...
  const touchMoveHandler = (e) => {
    ...
    setNewBeats((prevState) => [
      ...prevState,
      [e.changedTouches[0].pageX, e.changedTouches[0].pageY, dur, "holdSlide"],
    ]);
  };
  ...
  const touchEndHandler = (e) => {
    ...
    setNewBeats((prevState) => [
      ...prevState,
      [e.changedTouches[0].pageX, e.changedTouches[0].pageY, dur, "endSlide"],
    ]);
  };
